...
public class MainCapacitaciones {
	...
	public static void main(String[] args) {
		...
		while (!finalizar) {
	        ...
	        if(opt == 1) {
        		...
        		if(profSelec!=null) {
        			boolean session = profSelec.login();
        	...
        	//FIN PARTE PROFESOR
        		...
        		if(aluSelec!=null) {
        			boolean session = aluSelec.login();
        		...
        		if(adminSelec!=null) {
        			boolean session = adminSelec.login();
	...
	public static void mostrarMenuProf() {		
		...
		System.out.println("Opcion 3: Informacion personal");	
	...
	public static void mostrarMenuAlum() {		
		...
		System.out.println("Opcion 4: Información personal");
	...
	public static void mostrarMenuAdmin() {		
		...
		System.out.println("Opcion 5: Información personal");
		System.out.println("Opcion 6: Cerrar sesión");
		System.out.println("Ingrese una opción");
	...
	public static Docente crearDocente(Institucion inst) {		
		...
		inst.setUsuarios(docenteCreado);
		System.out.println("\nTodo salió correctamente!");
	...
	public static void bajaAlumno(Institucion i){
		...
		if(alu!=null) {
			...
			if(op==1) {
				int index = i.getUsuarios().indexOf(alu);				
				if(index==0){
					i.getUsuarios().clear();
					System.out.println("Registro eliminado con exito!");
				}
				else {
				i.getUsuarios().remove(index);
				System.out.println("Registro eliminado con exito!");
				}
			}
		}else {
	...
	public static void bajaProfesor(Institucion i){
		...
		if(prof!=null) {
			...
			if(op==1) {
				int index = i.getUsuarios().indexOf(prof);				
				if(index==0){
					i.getUsuarios().clear();
					System.out.println("Registro eliminado con exito!");
				}
